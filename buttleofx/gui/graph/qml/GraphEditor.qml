...
Item {
    ...
    ParamButtleEditor {                
        ...
        params: currentParamNode ? currentParamNode.params : null
        x: currentParamNode ? (currentParamNode.coord.x + 80)*graph.zoomCoeff  + graph.offsetX + (1-graph.zoomCoeff)*415 : 0
        y: currentParamNode ? (currentParamNode.coord.y + 95)*graph.zoomCoeff  + graph.offsetY + (1-graph.zoomCoeff)*200 : 0
    }
