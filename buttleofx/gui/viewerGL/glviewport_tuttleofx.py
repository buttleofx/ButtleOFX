...
class GLViewport_tuttleofx(GLViewport):
    def __init__(self, parent=None):
        ...
        buttleData.currentViewerNodeChangedPython.connect(self.loadImageFile_tuttle)
        #self.init_tuttle()

    # def reloadImage(self):
    #     self.loadImageFile_tuttle("")
    ...
    #     self.tuttleLensNode = self.tuttleGraph.createNode("tuttle.lensdistort", coef1=.5, #outOfImage='transparency',
    ...
    def loadImageFile_tuttle(self):
        print "------------------loadImageFile_tuttle--------------------"
        ...
        print "----------------End loadImageFile glviewport_tuttle-----------------------"
